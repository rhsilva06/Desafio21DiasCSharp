...
namespace Aula09
{
    internal class Program
    {
        ...
        public static Cliente ObtemCliente()
        {
            ...
            var busca = ClienteServico.Get().ObtemClientePorEmail(email);

            if (string.IsNullOrEmpty(busca.Id))            
            {
        ...
        public static void Cadastro()
        {
            ...
            ClienteServico.Get().Salvar(cliente);
        ...
        public static void Debito(Cliente cliente)
        {
            ...
            if (!string.IsNullOrEmpty(cliente.Id))
            {
                ...
                var id = cliente.Id;
                double saldo = ContaCorrenteServico.Get().ObtemSaldoCliente(id);
                ...
                if (saldo > 0)
                {
                    ...
                    else
                    {
                        ...
                        ContaCorrenteServico.Get().Lista.Add(conta);

                        saldo = ContaCorrenteServico.Get().ObtemSaldoCliente(id);
        ...
        public static void Credito(Cliente cliente)
        {
            ...
            if (!string.IsNullOrEmpty(cliente.Id))
            {
                ...
                ContaCorrenteServico.Get().Salvar(conta);
        ...
        public static void ListarClientes()
        {
            ...
            var lista = ClienteServico.Get().Lista;
            if (lista.Count() > 0)
            {
        ...
        public static void VerConta()
        {
            ...
            if (ClienteServico.Get().Lista.Count() > 0)
            {
                ...
                if (!string.IsNullOrEmpty(cliente.Id))
                {
                    ...
                    var conta = ContaCorrenteServico.Get().ObtemClienteConta(id);
                    if (conta.Count() > 0)
                    {
